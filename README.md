...
https://github.com/dothanhtruc/Customer-Segmentation-System/tree/main
## 🎯 Objectives
...
## 📁 File Descriptions
- 📓 **`Customer_Segmentation_System.ipynb`**: Jupyter notebook containing data exploration, visualization, modeling, and evaluation code.
...
2. **Open the Notebook**: Access the `Customer_Segmentation_System.ipynb` in Jupyter or Google Colab.
